	...
	const raw = Object.keys(process.env)
		...
		.reduce(
			...
			},
			{
				...
				SERVER_API_URL_TOKENS_REFRESH: process.env.SERVER_API_URL_TOKENS_REFRESH,
				SERVER_API_URL_SIGN_IN: process.env.SERVER_API_URL_SIGN_IN,
				SERVER_API_URL_SIGN_UP: process.env.SERVER_API_URL_SIGN_UP,
				SERVER_API_URL_RECOVERY: process.env.SERVER_API_URL_RECOVERY,
